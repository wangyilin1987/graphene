   ...
   class http_plugin_impl {
      public:
         ...
         void handle_http_request(typename websocketpp::server<T>::connection_ptr con) {
            try {
               ilog("handle_http_request begin");
